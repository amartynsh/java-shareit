...
public class ItemServiceImpl implements ItemService {
    ...
    public ItemDto addItem(ItemDto itemDto, long userId) {
        ...
        log.info("Сохранили Item {}", savedItem);
    ...
    public ItemDatesCommentsDto getItemById(long itemId, long userId) {
        ...
        List<CommentResponseDto> commentsDto = commentRepository.findAllByItemId(itemId)
                .stream()
    ...
    private ItemDatesCommentsDto getItemByIdForOwner(Item item) {
        ...
        List<CommentResponseDto> commentsDto = commentRepository.findAllByItemId(item.getId())
                .stream()
                .map(CommentMapper::toCommentResponseDto)
                .toList();
